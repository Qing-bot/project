...
CREATE TABLE Director (
    DirectorID char(5) NOT NULL CHECK (DirectorID LIKE 'DIR[0-9][0-9][0-9]'), 
...
CREATE TABLE [Movie Genre] (
    GenreID char(5) NOT NULL CHECK (GenreID like 'GEN[0-9][0-9][0-9]'), 
    [Name] varchar(255) NOT NULL, 
    PRIMARY KEY (GenreID));

CREATE TABLE Publisher (
    PublisherID char(5) NOT NULL CHECK (PublisherID LIKE'PUB[0-9][0-9][0-9]'), 
    [Name] varchar(255) NOT NULL, 
    Email varchar(255) NOT NULL CHECK (Email like '%@%'), 
    City varchar(255) NULL, 
...
CREATE TABLE [Sales Transaction Details] (
    SalesID char(5) NOT NULL CHECK (SalesID LIKE 'SAL[0-9][0-9][0-9]'), 
    UserID char(5) NOT NULL CHECK (UserID LIKE 'USR[0-9][0-9][0-9]'), 
    MovieID char(5) NOT NULL CHECK (MovieID LIKE 'MOV[0-9][0-9][0-9]'), 
